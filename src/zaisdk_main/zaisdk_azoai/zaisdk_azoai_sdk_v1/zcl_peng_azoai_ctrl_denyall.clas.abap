CLASS zcl_peng_azoai_ctrl_denyall DEFINITION
  ...
  PUBLIC SECTION.
    METHODS:
      zif_aisdk_centralcontrol~start_sdk REDEFINITION,
      zif_aisdk_centralcontrol~initialize_sdkcomponent REDEFINITION,
      zif_aisdk_centralcontrol~perform_operation REDEFINITION.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
